    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="mx-auto px-4 md:px-20">
        {loading ? (
          ...
          <>
            {/* <h2 className="font-['Mulish'] text-3xl font-bold text-center text-gray-800 mb-8">
              Now Showing
            </h2> */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-12">
              {movies.map((movie) => {
                ...
                return (
                  <div
                    key={movie.id}
                    className="bg-white font-['Mulish'] rounded-xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group"
                  >
