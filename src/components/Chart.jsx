...
const MovieSalesDashboard = () => {
  ...
  const [activeSalesMovie, setActiveSalesMovie] =
    useState("Avengers: End Game");
  const [activeSalesPeriod, setActiveSalesPeriod] = useState("Weekly");
  const [activeTicketCategory, setActiveTicketCategory] = useState(
  ...
  const getCurrentSalesData = () => {
    return (
      salesDataSets[activeSalesMovie]?.[activeSalesPeriod] ||
      salesDataSets["Avengers: End Game"]["Weekly"]
    );
  };

  const getCurrentTicketData = () => {
    const locationKey =
      activeTicketLocation === "Location" ? "Jakarta" : activeTicketLocation;
    return (
      ticketDataSets[activeTicketCategory]?.[locationKey] ||
      ticketDataSets["Adventure, Purwakarta"]["Jakarta"]
    );
  };
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600">
              {activeSalesMovie} - {activeSalesPeriod}
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
              <option value="Adventure, Purwakarta">
                Adventure, Purwakarta
              </option>
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600">
              {ticketCategory} -{" "}
              {ticketLocation === "Location" ? "All Locations" : ticketLocation}
            </p>
          </div>
